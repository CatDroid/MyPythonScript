...
dirLeft  = "/Volumes/MySanDisk/mysdk/bvt_model/HumanSeg_mobile_v2_unet_8_hhl_2023-11-16_put_BackGround_before_crop"
dirMid   = "/Volumes/MySanDisk/mysdk/bvt_model/HumanSeg_mobile_v2_unet_8_hhl_2023-11-06"
dirRight = "/Volumes/MySanDisk/mysdk/bvt_model/HumanSeg_u2net_small_16_sigmoid_2023-10-09_DataClean1_Pass"
dirGT    = "/Volumes/MySanDisk/mysdk/bvt_model/val_3_mask_clip"

OUTPUT_NAME = "L_Low_Clean_2---M_Low_Clean_1---R_High_Pass"
...
#         if not ret or not ret2 or not ret1 or not ret_mask:
...
# 定义ffmpeg命令
command = ['ffmpeg', '-i', OUTPUT_VIDEO_PATH, '-b:v', '6M' , OUTPUT_VIDEO_PATH_RESIZE]
