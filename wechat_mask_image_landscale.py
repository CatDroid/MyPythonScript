...
# 打开输入源视频  
INPUT_VIDEO_PATH  = '/home/hehanlong/wechat/blibli_mic_1916_1080.mp4'
OUTPUT_VIDEO_PATH = '/home/hehanlong/wechat/blibli_mic_1916_1080_merge.mp4'
...
output_video = cv2.VideoWriter(OUTPUT_VIDEO_PATH, fourcc, 30.0, (frame_width, frame_height*2)) 
...
while input_video.isOpened():
    ...
    if frame_num_a >= 4387 and frame_num_a <= 5848:
        pass
    else:
        frame_num_a = frame_num_a + 1 
        continue 

    mask_path = f"/home/hehanlong/wechat/temp_bilibi/1_1_224_128_SetImage_{frame_num_a - 4387}.rgba"
    print(f"open {mask_path}")
    mask_image = np.fromfile(mask_path , dtype='uint8')
    ...
    merged_img = cv2.vconcat([origin_image, output_image.astype(np.uint8)])
